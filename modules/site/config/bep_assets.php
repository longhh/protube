...
$config['asset'][] = array('file'=>'mytable.css');
$config['asset'][] = array('file'=>'jquery_ui.css', 'name'=>'jquery_ui_css');

// BackendPro JS
$config['asset'][] = array('file'=>'jquery.js', 'name'=>'jquery');
$config['asset'][] = array('file'=>'jquery_ui.js', 'needs'=>'jquery', 'name' => 'jquery_ui_js');
...
$config['asset'][] = array('file'=>'jquery.dataTables.js', 'needs'=>'jquery', 'name' => 'jquery_table');
$config['asset'][] = array('file'=>'jquery.form.js', 'needs'=>'jquery', 'name' => 'jquery_form');
$config['asset'][] = array('file'=>'tiny_mce/jquery.tinymce.js', 'needs'=>'jquery', 'name' => 'jquery_mce');

$config['asset'][] = array('file'=>'bep_dashboard.js', 'needs'=>'jquery_ui_js|jquery.cookie');
/**
 * Asset Groups
 * 
...
$config['asset_group']['MY_TABLE'] = 'mytable|jquery_table';
$config['asset_group']['MY_JQUERY_UI'] = 'jquery_ui_js|jquery_ui_css';
$config['asset_group']['MY_MCE'] = 'jquery_mce';
$config['asset_group']['MY_JQUERY_FORM'] = 'jquery_form';
